import svgPaths from "./svg-ckxhbwyxts";
...
function Group1({ className }: { className?: string }) {
  return (
    <div className={className}>
      <div className="absolute aspect-[3000/3000] left-0 right-0 top-0" data-name="Untitled_Artwork 138 1">
...
function LearnMoreButton() {
  return (
    <div className="absolute contents left-[716px] top-[660px]" data-name="Learn More Button">
      <div className="absolute bg-gradient-to-l from-[#ff5416] from-[50.481%] h-[62px] left-[716px] rounded-[20px] to-[#ff1b00] top-[660px] w-[180px]" />
      <p className="absolute font-['Days_One:Regular',sans-serif] h-[32px] leading-[normal] left-[760px] not-italic text-[25px] text-white top-[675px] w-[115px]">Try It!</p>
    </div>
  );
}
...
function Title() {
  return (
    <div className="absolute contents left-[720px] top-[210px]" data-name="Title">
      ...
      <div className="absolute h-[91.455px] left-[720px] top-[248px] w-[86.328px]" data-name="Vector">
...
function Group() {
  return (
    <div className="absolute contents left-[1283px] top-[12px]">
      <div className="absolute bg-[#008cff] h-[35px] left-[1283px] rounded-[10px] top-[12px] w-[103px]" />
      <p className="absolute font-['Days_One:Regular',sans-serif] h-[21.596px] leading-[normal] left-[1308px] not-italic text-[16px] text-white top-[21px] w-[85.22px]">Try It!</p>
    </div>
  );
}
...
function NavBar() {
  return (
    <div className="absolute contents left-0 top-0" data-name="NavBar">
      ...
      <Group />
      <p className="[text-underline-position:from-font] absolute decoration-solid font-['Pathway_Extreme:Regular',sans-serif] font-normal h-[40px] leading-[normal] left-[1152px] text-[#101545] text-[14px] top-[22px] underline w-[105px]" style={{ fontVariationSettings: "'wdth' 100" }}>
        Insights
      </p>
      <p className="[text-underline-position:from-font] absolute decoration-solid font-['Pathway_Extreme:Regular',sans-serif] font-normal h-[40px] leading-[normal] left-[1047px] text-[#101545] text-[14px] top-[22px] underline w-[67px]" style={{ fontVariationSettings: "'wdth' 100" }}>
        Sources
      </p>
      <p className="[text-underline-position:from-font] absolute decoration-solid font-['Pathway_Extreme:Regular',sans-serif] font-normal h-[40px] leading-[normal] left-[931px] text-[#101545] text-[14px] top-[22px] underline w-[90px]" style={{ fontVariationSettings: "'wdth' 100" }}>
        Simulation
      </p>
      <div className="absolute h-[33px] left-[23px] top-[17px] w-[31px]" data-name="Vector">
...
function OurPurpose() {
  return (
    <div className="absolute contents left-[107px] top-[1386px]" data-name="our purpose">
      ...
      <p className="absolute font-['Fira_Code:Regular',sans-serif] font-normal h-[458px] leading-[normal] left-[208px] text-[18px] text-white top-[1652px] w-[1058px] whitespace-pre-wrap">{`Multi-year history is backfilled from public archives (e.g., SullyGnome/TwitchTracker, SteamDB/SteamCharts, Kaggle mirrors), while official APIs (Twitch Helix, Steam Web) provide prospective, high-frequency snapshots that we roll up to hourly and daily series. Games are harmonized across platforms and mapped to a unified type taxonomy using IGDB genres plus Steam tags, enabling type-level aggregation. The project dives into two fields:  i) The activity cycles of different games and game types. This includes variables like Daily Active Users, purchase volumes, etc and top tags/type trends across major platforms.  ii)  Link between games and social media. This includes relationship between social-media buzz and game popularity, comment/keyword visualization, and real-time monitoring of fresh breakouts.`}</p>
      ...
      <div className="absolute h-[107px] left-[1148px] top-[1891px] w-[101px]" data-name="Vector">
...
function Group2() {
  return (
    <div className="absolute contents left-[39px] top-[106px]">
      ...
      <div className="absolute left-[39px] size-[650px] top-[106px]" data-name="Untitled_Artwork 137 1">
...
function Group3() {
  return (
    <div className="absolute contents left-[-266px] top-[4636px]">
      <div className="absolute left-[-266px] opacity-60 size-[1051px] top-[4636px]" data-name="Untitled_Artwork 137 1">
        <img alt="" className="absolute inset-0 max-w-none object-50%-50% object-cover pointer-events-none size-full" src={imgUntitledArtwork1371} />
      </div>
    </div>
  );
...
function YouTubeIcon() {
  return (
    <div className="absolute contents left-[636px] top-[3083px]" data-name="YouTube Icon">
      <div className="absolute h-[257px] left-[830px] shadow-[0px_4px_4px_0px_rgba(0,0,0,0.25)] top-[3277px] w-[363px]" data-name="Untitled_Artwork 142 1">
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          <img alt="" className="absolute h-[231.48%] left-[-30.83%] max-w-none top-[-72.99%] w-[164.29%]" src={imgUntitledArtwork1421} />
        </div>
      </div>
      <div className="absolute left-[636px] size-[393px] top-[3083px]" data-name="Untitled_Artwork 143 1">
...
function TwitchIcon() {
  return (
    <div className="absolute contents left-[-128px] top-[3552px]" data-name="Twitch Icon">
      <div className="absolute left-[101px] shadow-[0px_4px_4px_0px_rgba(0,0,0,0.25)] size-[572px] top-[3707px]" data-name="Untitled_Artwork 147 1">
      ...
      <div className="absolute left-[-128px] size-[656px] top-[3552px]" data-name="Untitled_Artwork 148 1">
      ...
      <div className="absolute left-[387px] size-[444px] top-[3916px]" data-name="Untitled_Artwork 149 1">
...
export default function Home() {
  return (
    <div className="bg-white relative size-full" data-name="Home">
      ...
      <div className="absolute left-[131px] shadow-[0px_4px_4px_0px_rgba(0,0,0,0.25)] size-[530px] top-[2571px]" data-name="Untitled_Artwork 140 1">
      ...
      <Frame />
      <TwitchIcon />
      <p className="absolute font-['Fira_Code:Regular',sans-serif] font-normal h-[167px] leading-[normal] left-[850px] text-[#101545] text-[18px] top-[2709px] w-[442px]">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.</p>
      ...
      <p className="absolute font-['Fira_Code:Regular',sans-serif] font-normal h-[167px] leading-[normal] left-[131px] text-[#101545] text-[18px] top-[3340px] w-[442px]">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.</p>
      <p className="absolute font-['Fira_Code:Regular',sans-serif] font-normal h-[167px] leading-[normal] left-[848px] text-[#101545] text-[18px] top-[3967px] w-[442px]">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.</p>
    </div>
  );
}