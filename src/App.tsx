...
export default function App() {
  return (
    <div className="bg-gray-50 min-h-screen w-full flex justify-center overflow-x-hidden p-4 md:p-8" data-name="Home">
      <div className="bg-white relative w-full max-w-[1440px] h-[5341px] overflow-hidden border border-[#101545] shadow-xl">
        <TopBg />
