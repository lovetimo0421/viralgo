  ...
  return (
    <div>
      <motion.div 
        ...
        style={{ position: 'absolute', top: '7359px', left: '-266px', width: '1051px', height: '1051px' }}
...
function Group2() {
  return (
    <div className="leading-[24px] text-[18px] text-nowrap text-white whitespace-pre">
      <p className="font-bold" style={{ ...BODY_FONT, position: 'absolute', left: 'calc(75% - 17px)', top: '7662px' }}>Sources</p>
      <div className="font-normal" style={{ ...BODY_FONT, position: 'absolute', left: 'calc(75% - 17px)', top: '7723px' }}>
      ...
      <div className="font-normal" style={{ ...BODY_FONT, position: 'absolute', left: 'calc(58.33% + 1px)', top: '7723px' }}>
        <motion.p className="mb-0 cursor-pointer" whileHover={{ scale: 1.05, color: "#ff8b16" }} whileTap={{ scale: 0.95 }}>
      ...
      <p className="font-bold" style={{ ...BODY_FONT, position: 'absolute', left: 'calc(58.33% + 1px)', top: '7662px' }}>Data</p>
    </div>
  );
}
...
function Footer() {
  return (
    <div data-name="Footer">
      <div className="bg-[#101545]" style={{ position: 'absolute', width: '1440px', height: '484px', left: '0', top: '7583px' }} />
      <div className="flex items-center justify-center" style={{ position: 'absolute', width: '1442px', height: '961px', left: '-2px', top: '6979px' }}>
...
function TimelineOfHitGames() {
  return (
    <div data-name="Timeline of Hit Games">
      <Group4 />
      <p className="leading-[normal] not-italic text-[#ff5416] text-[60px]" style={{ ...HEADER_FONT, position: 'absolute', height: '112px', left: '90px', top: '1015px', width: '734px' }}>Timeline of Hit Genres</p>
  ...
  return (
    <div>
      <GenreMoneyMap 
        ...
        style={{ position: 'absolute', height: '846px', left: '65px', top: '2560px', width: '1305px' }}
      />
    </div>
  );
}
...
function ReleaseFloodVsSignal() {
  return (
    <div data-name="Release Flood vs. Signal">
      <Group5 />
      <p className="leading-[normal] not-italic text-[#ff5416] text-[60px]" style={{ ...HEADER_FONT, position: 'absolute', height: '112px', left: '87px', top: '2436px', width: '1011px' }}>Where's the Money?</p>
      <Group3 />
...
function TopGamesSection() {
  return (
    <div data-name="Top Games Section">
       <p className="leading-[normal] not-italic text-[#ff5416] text-[60px]" style={{ ...HEADER_FONT, position: 'absolute', height: '112px', left: '87px', top: '3714px', width: '1011px' }}>Top Games by Year</p>
       
       {/* Chart Container */}
       <div className="bg-white rounded-[20px] shadow-[0px_4px_20px_0px_rgba(0,0,0,0.25)] p-4" style={{ position: 'absolute', left: '65px', top: '3850px', width: '1305px', height: '600px' }}>
          <TopGamesChart className="w-full h-full" />
       </div>

       <p className="font-normal leading-[24px] text-[#101545] text-[16px]" style={{ ...BODY_FONT, position: 'absolute', height: '167px', left: '113px', top: '4525px', width: '1204px' }}>
...
function HistoryOfPopularity() {
  return (
    <div data-name="History of Popularity">
      <p className="leading-[normal] not-italic text-[#101545] text-[80px] text-center" style={{ ...HEADER_FONT, position: 'absolute', height: '112px', left: 'calc(8.33% + 599.5px)', top: '544px', transform: 'translateX(-50%)', width: '1049px' }}>History of Popularity</p>
      ...
      <div className="h-0" style={{ position: 'absolute', width: '498px', left: 'calc(25% + 111px)', top: '658px' }}>
...
function HistoryOfPopularity1() {
  return (
    <div data-name="History of Popularity">
      <p className="leading-[normal] not-italic text-[#101545] text-[80px] text-center" style={{ ...HEADER_FONT, position: 'absolute', height: '112px', left: 'calc(8.33% + 597.5px)', top: '4804px', transform: 'translateX(-50%)', width: '1049px' }}>Hype Today</p>
      ...
      <div className="h-0" style={{ position: 'absolute', width: '498px', left: 'calc(25% + 109px)', top: '4934px' }}>
        <div className="absolute bottom-0 left-0 right-0 top-[-3px]">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 498 3">
            <line id="Line 1" stroke="var(--stroke-0, #FF5416)" strokeWidth="3" x2="498" y1="1.5" y2="1.5" />
          </svg>
...
function Group6() {
  return (
    <div>
      ...
      <div className="overflow-hidden shadow-lg z-0" style={{ position: 'absolute', left: '0', top: '0', width: '100%', height: '400px' }}>
          <Header />
      </div>
    </div>
  );
  ...
  return (
    <div className="bg-gray-50 min-h-screen w-full flex justify-center overflow-x-hidden p-8" data-name="Data">
      <div 
        ...
        style={{ position: 'relative', height: '8067px', border: '1px solid #101545' }}
      >
          <Footer />
          <Group6 />
          <TimelineOfHitGames />
