...
function OurPurpose() {
  return (
    <div className="absolute contents left-[107px] top-[1386px]" data-name="our purpose">
      ...
      <p className="absolute font-normal h-[458px] leading-[normal] left-[208px] text-[18px] text-white top-[1652px] w-[1058px] whitespace-pre-wrap" style={{ fontFamily: 'Fira Code' }}>{`This project answers four key questions (and relevant subquestions) that capture how the gaming industry has changed over time: How has the popularity of certain genres changed over time? Why do some genres generate more revenue than others, and how might this be explained by the relationship between genre Average Units Sold vs Average Revenue vs Peak Load? Which specific game titles on Steam have been the most popular over time, and what does this show us about the relationship between genre trends and specific titles?Which gaming trends do we see today by platform, genre, and session duration? By answering these questions, we seek to explain the evolution of the industry over the past 15 years from 2010 to 2025. The purpose of this website is to convey this information as interactively and intuitively as possible. To achieve this, we uniquely link game performance, genre economics, and social buzz across decades with controls that let users actively toggle time ranges, platforms, and genres.`}</p>
  ...
  return (
    <div className="bg-gray-50 min-h-screen w-full flex justify-center overflow-x-hidden p-8" data-name="Home">
      ...
      >
        ...
        <p className="absolute font-normal h-[167px] leading-[normal] left-[720px] text-[20px] text-white top-[431px] w-[616px]" style={{ fontFamily: 'Fira Code', whiteSpace: 'pre-wrap' }}>{`This project quantifies trends in the video game industry over time, including an analysis of the most popular games and genres among players, streaming platforms, and the economic success of different genres. The site also examines gaming trends today by platform, genre, and session duration, serving streamers and game creators researching current and future industry trends.`}</p>
        <LearnMoreButton />
